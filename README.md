...
*   The JRE flavor requires JDK 26 or higher.
...
Guava provides two different "flavors": one for use on a (Java 26+) JRE and one
...
6.  For the mainline flavor, we test the libraries using OpenJDK 26
